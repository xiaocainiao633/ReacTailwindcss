...
const features = [
    {
        ...
        description:
        "Intelligent code suggestions powered by advanced AI that from your life.",
        codeSnippet: 
        `    function handleSubmit(){
        // AI suggests nextline
    ...
    },
    {
        ...
        description:
        "Generate comprehensive test suites automatically. Our AI analyzes your request.",
        codeSnippet: 
    ...
    },
    {
        ...
        description:
        "Identity and fix bugs before they reach production. AI-powered error debugging tools.",
       codeSnippet: 
        `    // AI suggests fix:
    ...
    return (
        ...
        >
            <div className="max-w-6xl mx-auto">
                ...
                <div className="space-y-16 sm:space-y-20 lg:spacae-y-32">
                        ...
                        <div key={key} className={`flex flex-col lg:flex-row items-center gap-8 sm:gap-12 ${feature.imagePosition === "right" ? "lg:flex-row-reverse" : ""}`}>
                            ...
                            <div className="flex-1 w-full">
                                <div className="relative group">
                                    ...
                                    <div
                                        className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 overflow-hidden group-hover:border-1 group-hover:border-blue-600/50 transition-all duration-300"
                                    >
                                        {/* Ide Interface */}
                                        <div className="bg-gray-950 rounded-lg p-3 sm:p-4 font-mono text-xs sm:text-sm">
                                            <div className="flex items-center space-x-1 sm:space-x-2 mb-3 sm:mb-4">
                                                ...
                                                <span classNeme="text-gray-400 ml-2 sm:ml-4 text-xs sm:text-sm">
                                                    {feature.title}
                                                </span>
                                            </div>
                                            <div>
